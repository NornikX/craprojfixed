...
uint256 hashGenesisBlock("0x4d7de2779e763c225c25c4e8909285c70d7a4a77687d6fbc91a773c21f6c4ec1");
...
int64 static GetBlockValue(int nHeight, int64 nFees) {
    int64 nSubsidy = COIN;
        // this is official premine 0,7% for bounties and giveaways
    if(nHeight < 2) {
        nSubsidy = 60540 * COIN;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaf6f2b3af3864449c8b24b9c6fe44da29f754ca12ede6fe1dbb37776b96d950b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Feb 17 2014, 2:18 GMT +1 we are now compiling fully working CRA the only ONE REAL CRA! We have lost the battle with motherfuckers, but we will win the war! Yours CRA Team!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1392607393;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 3612879;

        if (fTestNet)
        {
            block.nTime    = 1392599829;
            block.nNonce   = 2402003;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x7834e57df25662f1061b11033cca8db93e3c4b5018a945abc96959acea6f7677"));
